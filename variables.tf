...
variable "vm_size" {
  ...
  # CF - added Standard_DS1_v2 as default, might need to change
...
variable "data_disk_size" {
  ...
  # CF - added default of 100 but change valuie to something else
  default     = "100"
}

variable "admin_username" {
  type        = string
  # CF - added default of CPU_Admin but this might need to change
...
variable "admin_password" {
  ...
  # CF - added default of below but will need changing
  default = "Pa$$w0rd"
}
